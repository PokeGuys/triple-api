...
class Attraction extends Model
{
    ...
    protected $fillable = ['description', 'place_id', 'city_id', 'name', 'local_name', 'phone', 'website', 'email', 'opening_hours', 'popular', 'address', 'tags', 'photos', 'latitude', 'longitude', 'rating', 'rating_count', 'price_level', 'comment_count', 'photo_count'];
