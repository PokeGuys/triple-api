...
class Attraction extends Model
{
    ...
    protected $fillable = ['place_id', 'city_id', 'name', 'phone', 'website', 'email', 'opening_hours', 'popular', 'address', 'tags', 'photos', 'latitude', 'longitude', 'rating', 'price_level', 'comment_count', 'photo_count'];
